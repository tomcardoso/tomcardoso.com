...
function createExhibit()
{
	...
	foreach ($pages as $go)
	{
		...
		$a .= "\n<div><img src='" . BASEURL . GIMGS . "/$go[media_file]' class='img-bot' /><p><span class='img-title'>{$title}</span><span class='img-caption'>{$caption}</span></p></div>\n";
...
function dynamicCSS()
{
	...
	.img-bot {margin-bottom: 2px; display: block; margin-right: 40px; }";
}
